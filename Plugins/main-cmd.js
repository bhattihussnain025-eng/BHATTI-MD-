...
console.log(`BHATTI-MD ♻ Auto Bio Started`);
//============================ Env=======================================================
...
async (conn, mek, m, { from }) => {
    try {
        ...
        const ownerNumber = '+923181742221'; // Replace this with the actual owner number
        const ownerName = 'BHATTIMD Official'; // Replace this with the owner's name
        const organization = 'BHATTI CODERS'; // Optional: replace with the owner's organization
        ...
        await conn.sendMessage(from, {
            ...
            contextInfo: {
                mentionedJid: [ownerNumber.replace('+923181742221', '') + '+923181742221@s.whatsapp.net'], // Mention the owner
...
try{
let dec = `> BHATTI-MD REPO INFO 🪀

╭⦁⦂⦁*━┉━┉━┉━┉━┉━┉━⦁⦂⦁
┃ 𝙾𝚆𝙽𝙴𝚁 𝙽𝚄𝙼𝙱𝙴𝚁: ${923181742221}
┃ 
